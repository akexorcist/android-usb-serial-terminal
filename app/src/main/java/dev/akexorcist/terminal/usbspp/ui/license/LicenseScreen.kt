package dev.akexorcist.terminal.usbspp.ui.license
...
@Composable
fun LicenseScreen(onNavigateBack: () -> Unit, modifier: Modifier = Modifier) {
    Scaffold(
        modifier = modifier,
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.device_list_menu_license)) },
                navigationIcon = {
        ...
        Column(
            ...
            Column(modifier = Modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
                Text(text = "Apache License", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold, textAlign = TextAlign.Center)
                Text(text = "Version 2.0, January 2004", style = MaterialTheme.typography.bodyMedium, textAlign = TextAlign.Center)
                Text(text = "http://www.apache.org/licenses/", style = MaterialTheme.typography.bodyMedium, textAlign = TextAlign.Center)
            }

            apacheLicenseParagraphs.forEach { paragraph ->
...
private val apacheLicenseParagraphs =
    listOf(
        ...
        "\"Derivative Works\" shall mean any work, whether in Source or Object form, that is based on (or derived " +
                "from) the Work and for which the editorial revisions, annotations, elaborations, or other " +
...
private fun LicenseScreenPreview() {
    UsbSerialTerminalTheme { LicenseScreen(onNavigateBack = {}) }
}
